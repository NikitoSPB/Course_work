...
void bubbleSort(int* arr, int f_countElements)
{
    int* f_endArray = arr + f_countElements - 1;
    for (int* f_i = arr; f_i < f_endArray - 1; f_i++)
    {
        bool sort_flag = true;
...
void insertSort(int* arr, int f_countElements)
{
    int* f_endArray = arr + f_countElements;
...
void shakerSort(int* arr, int f_countElements)
{
    int* first = arr, * last = arr + f_countElements - 1;
    while (first < last)
    {
...
void combSort(int* arr, int temp, int f_countElements)
{
    int* f_endArray = arr + f_countElements - 1;
    while (temp >= 1)
    {
