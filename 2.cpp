...
void quickSort2(int* arr, int* begin, int* end)
{
	...
	if (begin < last)
		quickSort2(arr, begin, last);
	if (first < end)
		quickSort2(arr, first, end);
}
...
void sort(int* sArr)
{
	...
	case 5:
		start1 = steady_clock::now();
		quickSort2(sArr, sArr, sArr + countElements - 1);
		end1 = steady_clock::now();
		result1 = duration_cast<nanoseconds>(end1 - start1);
		cout << "Time: ";
		cout << result1.count();
...
void menu2()
{
	...
	case 3:
		...
		cout << result.count();
		cout << " ns\n\n";
		quickSort2(array, array, array + countElements - 1);
